...
cat filters/list-adservers.txt | grep -v '!' | awk '{print $1}' >> tmp/list-adservers.tmp
cat filters/list-adservers-all.txt | grep -v '!' | awk '{print $1}' >> tmp/list-adservers-all.tmp
